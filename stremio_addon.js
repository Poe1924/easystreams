    ...
    if (normalizedType === 'movie') {
        if (isKitsuRequest) {
            ...
            plan = likelyAnime
                ...
                : ['mediaset', 'raiplay', 'streamingcommunity', 'vidxgo', 'guardahd', 'guardoserie', 'altadefinizionestreaming'];
        } else if (likelyAnime || ENABLE_ANIME_FALLBACK_ON_MOVIES) {
            plan = ['animeunity', 'animeworld', 'animesaturn', 'guardoserie'];
        } else {
            plan = ['mediaset', 'raiplay', 'streamingcommunity', 'vidxgo', 'guardahd', 'guardoserie', 'altadefinizionestreaming'];
        }
...
builder.defineStreamHandler(async ({ type, id, config = {} }) => {
    ...
    const streamResolutionPromise = (async () => {
        ...
        validStreams.sort((a, b) => {
            ...
            // 4. Provider priority
            const providerOrder = ['mediaset', 'raiplay', 'animeunity', 'animeworld', 'animesaturn', 'guardoserie', 'streamingcommunity', 'vidxgo', 'altadefinizionestreaming', 'guardahd'];
